...
namespace presentation {
    public partial class EditGuestRequestPage : ValidatedPage {
        ...
        private void EditGuestRequest(object sender, RoutedEventArgs e) {
            ...
            (selected_cities.Count() == 0 ? Business.Cities : GuestRequest.Cities = city.SelectedItem as City).ToHashSet();
            (selected_types.Count() == 0 ? Business.UnitTypes : GuestRequest.DesiredUnitTypes = selected_types.SelectedItems as UnitTypes).ToHashSet();
